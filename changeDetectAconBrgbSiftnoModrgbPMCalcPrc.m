...
function  [area, xmin,ymin,wid,len] = changeDetectAconBrgbSiftnoModrgbPMCalcPrc(pathA,pathB,figNum, iter, boxRatio, ransacThre,  labeledPositions, patch_w, win_size)
%     tic;
...
%     disp(['Max distance of annp channel-3: ',num2str(bnnp(bnnp3y_max,bnnp3x_max,3)) ]);
    disp(['noMod rgbPM Prc PANO: ',pathA(strfind(pathA,'pano')+4:end-4),' FRAME: ',pathB(strfind(pathB,'image'):end-4), ...
...
%     tThre = boxRatio * mean_bnnp3;
    ...
    subplot(221) ,imagesc(doubleBnnpCh3);
