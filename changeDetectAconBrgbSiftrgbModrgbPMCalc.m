...
function  [xmin,ymin,wid,len] = changeDetectAconBrgbSiftrgbModrgbPMCalc(pathA,pathB,figNum, iter, boxRatio, ransacThre,  labeledPositions, patch_w, win_size)
%     tic;
...
%     disp(['Max distance of annp channel-3: ',num2str(bnnp(bnnp3y_max,bnnp3x_max,3)) ]);
    disp(['rgbMod rgbPM PANO: ',pathA(strfind(pathA,'pano'):end),' FRAME: ',pathB(strfind(pathB,'image'):end), ...
