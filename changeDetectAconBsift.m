...
function  [score1,score2,score3] = changeDetectAconBsift(pathA,pathB,videoName, figNum, iter, boxRatio, thre)
%     tic;
...
%     imshow(annp(:,:,3),[]);
    ...
    %% RANSAC on frame to create box on pano
...
%     end
    ...
    dir = strcat('./video/',videoName,'/noModulated/sift/withResizePatchMatch/Thre',num2str(thre),'/AconsBiter',num2str(iter),'boxR',num2str(boxRatio));
