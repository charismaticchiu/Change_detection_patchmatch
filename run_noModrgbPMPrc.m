...
%             win_size = 200;
                r = r + 1;
                [area,xmin,ymin,wid,len]= changeDetectAconBrgbSiftnoModrgbPMCalcPrc(panoName, frameName, ...
...
%     end
    ...
    changeDetectAconBrgbSiftnoModrgbPMPrc7 = performanceRecord;
    save(strcat('./video/Label/','changeDetectAconBrgbSiftnoModrgbPMPrc7.mat'),'changeDetectAconBrgbSiftnoModrgbPMPrc7');
end
toc