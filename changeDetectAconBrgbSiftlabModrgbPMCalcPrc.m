...
function  [area,xmin,ymin,wid,len] = changeDetectAconBrgbSiftlabModrgbPMCalcPrc(pathA,pathB,figNum, iter, boxRatio, ransacThre,  labeledPositions, patch_w, win_size)
%     tic;
...
%     end
    ...
    dir = strcat('./video/Label/rgbSiftlabModrgbPMPrc/ransacThre',...
